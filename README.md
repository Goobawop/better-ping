...
This script also assumes you keep your ping logs under $HOME/logs/ping/. Adjust the code to fit your use-case. If you want to use the default convention, then create the necessary directories and off you go!
